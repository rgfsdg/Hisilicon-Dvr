...
function ClickHi() {
    ...
    {
        g_playStyle=0;
        aa=setInterval("playAll()",50)//时间间隔
    }
    else
    {   g_playStyle=1;
...
function MessageBox() {
wrap="<div id='versionB' style='position:absolute;font-family: 宋体, Arial, Helvetica, sans-serif;color: #000000;width:300px;height:220px;margin:200px 0 0 50%;z-index:1000;background-color: RGB(255,255,255)'>"
