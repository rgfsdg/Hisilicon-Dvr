class PelcoD extends PtzBase{
	...
	StartOpr = {
		...
		AutoPanOn	  = [0xff, 0x00, 0x00, 0x07, 0x00, 0x63, 0x00],
		AutoPanOff	= [0xff, 0x00, 0x00, 0x07, 0x00, 0x60, 0x00],
		...
		MenuEnter = [0xff, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00],	
		MenuEsc = [0xff, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00],
	...
	StopOpr = {
		...
		MenuEnter = [0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00],	
		MenuEsc 	= [0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00],
