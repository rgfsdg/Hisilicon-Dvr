class Hikvision extends RS485Base{
	...
	KEYOperator = {
				...
				KEYFUNC = [0x25, KEYVALUE.KEY_FUNC],
				KEYPTZ  = [0x38, KEYVALUE.KEY_PTZ],
				...
				KEYRFOCUSNEAR = [0x81, KEYVALUE.KEY_FOCUS_NEAR],
				KEYFOCUSFAR   = [0x41, KEYVALUE.KEY_FOCUS_FAR],
				KEYTELE       = [0x61, KEYVALUE.KEY_TELE],
				KEYWIDE       = [0xa1, KEYVALUE.KEY_WIDE],
				KEYIRISOPEN   = [0xc1, KEYVALUE.KEY_IRIS_OPEN],
				KEYIRISCLOSE  = [0x21, KEYVALUE.KEY_IRIS_CLOSE],
				KEY10PLUS     = [0xc8, KEYVALUE.KEY_10PLUS],
				}	
